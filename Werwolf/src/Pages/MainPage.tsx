...
export default function MainPage() {
  ...
  return (
    <div
      className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center px-6 py-6"
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-2xl gap-6 md:gap-8">
        ...
        >
          <motion.div
            animate={{
              filter: [
                "drop-shadow(0 0 20px rgba(200,80,0,0.6))",
                "drop-shadow(0 0 45px rgba(255,120,0,0.9))",
                "drop-shadow(0 0 20px rgba(200,80,0,0.6))",
              ],
            }}
        ...
        >
          <h1
            className="text-4xl md:text-6xl font-black uppercase tracking-widest leading-tight"
            style={{
              fontFamily: "'Cinzel Decorative', Georgia, serif",
              background:
                "linear-gradient(180deg, #fff8dc 0%, #f5c842 30%, #c8701a 65%, #7a3500 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              textShadow: "none",
              filter: titleGlow
                ? "drop-shadow(0 0 30px rgba(255,150,30,0.8))"
                : "drop-shadow(0 0 10px rgba(200,100,0,0.4))",
          ...
          <h2
            className="text-lg md:text-2xl tracking-[0.4em] uppercase mt-1"
        ...
        >
          <OrnamentalDivider />
          <p
            className="text-xs tracking-[0.35em] uppercase mt-3"
            style={{
