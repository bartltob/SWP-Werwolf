                ...
                <div className="md:col-span-2 flex flex-col gap-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold tracking-wide">Werewolf Lobby</h1>
                                <p className="text-zinc-400 text-sm">Waiting for more players...</p>
                            </div>
                        </div>
                ...
                <div className="flex flex-col justify-between gap-6">
                    <div className="bg-zinc-800/60 rounded-2xl p-6 border border-zinc-700 flex flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between bg-zinc-900 rounded-xl px-4 py-3 border border-zinc-700">
                            <span className="tracking-widest font-semibold">{roomCode}</span>
                            <button
                                onClick={handleCopy}
